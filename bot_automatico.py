...
try:
    ...
    try:
        ...
        with col_ia:
            ...
            # 🧠 ALGORITMO DINAMICO: Investe sempre il 20% del capitale per l'interesse composto automatico
            importo_dinamico = saldo_reale * 0.20
            if importo_dinamico < 10: importo_dinamico = 10  # Protezione minima obbligatoria
            ...
            try:
                ...
                if previsione == 1:
                    ...
                    qty_calcolata = round(importo_dinamico / prezzo_attuale, 4) if "/" in ticker_cercato else round(importo_dinamico / prezzo_attuale, 2)
        ...
        with col_grafico:
            st.info("📊 In attesa dell'apertura dei mercati o inserimento ticker valido...")

except Exception as e:
    st.error(f"Errore generale di sincronizzazione: {e}")
